...
def format_frames(frame, output_size):
  ...
  """
    custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.image.convert_image_dtype(*args)', method_object=None, object_signature=None, function_args=[eval('frame'), eval('tf.float32')], function_kwargs={})
...
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='layers.GRU(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'units': eval('4'), 'return_sequences': eval('True'), 'return_state': eval('True')})
gru = layers.GRU(units=4, return_sequences=True, return_state=True)
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.random.normal(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'shape': eval('[1, 10, 8]')})
...
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='obj(*args, **kwargs)', method_object=eval('gru'), object_signature=None, function_args=[eval('inputs[:,5:, :]')], function_kwargs={'initial_state': eval('state')}, custom_class=None)
(second_half, _) = gru(inputs[:, 5:, :], initial_state=state)
print(np.allclose(result[:, :5, :], first_half))
print(np.allclose(result[:, 5:, :], second_half))
model_id = 'a0'
resolution = 224
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.keras.backend.clear_session()', method_object=None, object_signature=None, function_args=[], function_kwargs={})
...
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.train.latest_checkpoint(*args)', method_object=None, object_signature=None, function_args=[eval('checkpoint_dir')], function_kwargs={})
checkpoint_path = tf.train.latest_checkpoint(checkpoint_dir)
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.train.Checkpoint(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'model': eval('model')})
checkpoint = tf.train.Checkpoint(model=model)
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='obj.restore(*args)', method_object=eval('checkpoint'), object_signature=None, function_args=[eval('checkpoint_path')], function_kwargs={}, custom_class=None)
...
num_epochs = 2
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.keras.losses.SparseCategoricalCrossentropy(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'from_logits': eval('True')})
loss_obj = tf.keras.losses.SparseCategoricalCrossentropy(from_logits=True)
custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.keras.optimizers.Adam(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'learning_rate': eval('0.001')})
...
def get_actual_predicted_labels(dataset):
  ...
  """
    ...
    custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.stack(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('actual')], function_kwargs={'axis': eval('0')})
    actual = tf.stack(actual, axis=0)
    custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.concat(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('predicted')], function_kwargs={'axis': eval('0')})
    predicted = tf.concat(predicted, axis=0)
    custom_method(imports='from official.projects.movinet.modeling import movinet;import tensorflow as tf;from tensorflow.keras.losses import SparseCategoricalCrossentropy;import matplotlib.pyplot as plt;import cv2;import keras;import collections;import seaborn as sns;from tensorflow.keras.optimizers import Adam;import pathlib;import random;import tqdm;import numpy as np;import remotezip as rz;import tensorflow_hub as hub;from official.projects.movinet.modeling import movinet_model;from tensorflow.keras import layers;import itertools', function_to_run='tf.argmax(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('predicted')], function_kwargs={'axis': eval('1')})
