...
class MNISTCompressionTrainer(tf.keras.Model):
    ...
    def __init__(self, latent_dims):
        ...
        custom_method(imports='import tensorflow_compression as tfc;import tensorflow_datasets as tfds;import os;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.Variable(*args)', method_object=None, object_signature=None, function_args=[eval('tf.zeros((latent_dims,))')], function_kwargs={})
    ...
    def call(self, x, training):
        ...
        custom_method(imports='import tensorflow_compression as tfc;import tensorflow_datasets as tfds;import os;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.reshape(*args)', method_object=None, object_signature=None, function_args=[eval('x'), eval('(-1, 28, 28, 1)')], function_kwargs={})
        x = tf.reshape(x, (-1, 28, 28, 1))
        y = self.analysis_transform(x)
        entropy_model = tfc.ContinuousBatchedEntropyModel(self.prior, coding_rank=1, compression=False)
        (y_tilde, rate) = entropy_model(y, training=training)
        x_tilde = self.synthesis_transform(y_tilde)
        custom_method(imports='import tensorflow_compression as tfc;import tensorflow_datasets as tfds;import os;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.reduce_mean(*args)', method_object=None, object_signature=None, function_args=[eval('rate')], function_kwargs={})
        rate = tf.reduce_mean(rate)
        custom_method(imports='import tensorflow_compression as tfc;import tensorflow_datasets as tfds;import os;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.reduce_mean(*args)', method_object=None, object_signature=None, function_args=[eval('abs(x - x_tilde)')], function_kwargs={})
...
def display_digits(originals, strings, entropies, reconstructions):
    ...
    for i in range(len(axes)):
        custom_method(imports='import tensorflow_compression as tfc;import tensorflow_datasets as tfds;import os;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.concat(*args)', method_object=None, object_signature=None, function_args=[eval('[\n        tf.squeeze(originals[i]),\n        tf.zeros((28, 14), tf.uint8),\n        tf.squeeze(reconstructions[i]),\n    ]'), eval('1')], function_kwargs={})
...
import os
custom_method(imports='import tensorflow_compression as tfc;import tensorflow_datasets as tfds;import os;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.constant(*args)', method_object=None, object_signature=None, function_args=[eval('[os.urandom(8) for _ in range(16)]')], function_kwargs={})
