...
utils.text_dataset_from_directory(train_dir, batch_size=batch_size, validation_split=0.2, subset='validation', seed=seed), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'validation'"), 'seed': eval('seed')}, max_wait_secs=0)
test_dir = dataset_dir / 'test'
raw_test_ds = custom_method(
utils.text_dataset_from_directory(test_dir, batch_size=batch_size), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, function_args=[eval('test_dir')], function_kwargs={'batch_size': eval('batch_size')}, max_wait_secs=0)
VOCAB_SIZE = 10000
binary_vectorize_layer = custom_method(
TextVectorization(max_tokens=VOCAB_SIZE, output_mode='binary'), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='TextVectorization(**kwargs)', method_object=None, function_args=[], function_kwargs={'max_tokens': eval('VOCAB_SIZE'), 'output_mode': eval("'binary'")}, max_wait_secs=0)
...
create_model(vocab_size=VOCAB_SIZE + 1, num_labels=4), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='obj(**kwargs)', method_object=eval('create_model'), function_args=[], function_kwargs={'vocab_size': eval('VOCAB_SIZE + 1'), 'num_labels': eval('4')}, max_wait_secs=0, custom_class=None)
custom_method(
int_model.compile(loss=losses.SparseCategoricalCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy']), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='obj.compile(**kwargs)', method_object=eval('int_model'), function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, max_wait_secs=0, custom_class=None)
history = custom_method(
int_model.fit(int_train_ds, validation_data=int_val_ds, epochs=5), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('int_model'), function_args=[eval('int_train_ds')], function_kwargs={'validation_data': eval('int_val_ds'), 'epochs': eval('5')}, max_wait_secs=0, custom_class=None)
print('Linear model on binary vectorized data:')
print(binary_model.summary())
print('ConvNet model on int vectorized data:')
print(int_model.summary())
(binary_loss, binary_accuracy) = custom_method(
binary_model.evaluate(binary_test_ds), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='obj.evaluate(*args)', method_object=eval('binary_model'), function_args=[eval('binary_test_ds')], function_kwargs={}, max_wait_secs=0, custom_class=None)
...
export_model.predict(inputs), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='obj.predict(*args)', method_object=eval('export_model'), function_args=[eval('inputs')], function_kwargs={}, max_wait_secs=0, custom_class=None)
predicted_labels = custom_method(
tf.math.argmax(predicted_scores, axis=1), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='tf.math.argmax(*args, **kwargs)', method_object=None, function_args=[eval('predicted_scores')], function_kwargs={'axis': eval('1')}, max_wait_secs=0)
for (input, label) in zip(inputs, predicted_labels):
    print('Question: ', input)
    print('Predicted label: ', label.numpy())
train_ds = custom_method(
tfds.load('imdb_reviews', split='train[:80%]', batch_size=BATCH_SIZE, shuffle_files=True, as_supervised=True), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='tfds.load(*args, **kwargs)', method_object=None, function_args=[eval("'imdb_reviews'")], function_kwargs={'split': eval("'train[:80%]'"), 'batch_size': eval('BATCH_SIZE'), 'shuffle_files': eval('True'), 'as_supervised': eval('True')}, max_wait_secs=0)
...
model = custom_method(
create_model(vocab_size=VOCAB_SIZE + 1, num_labels=1), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='obj(**kwargs)', method_object=eval('create_model'), function_args=[], function_kwargs={'vocab_size': eval('VOCAB_SIZE + 1'), 'num_labels': eval('1')}, max_wait_secs=0, custom_class=None)
custom_method(
model.summary(), imports='from tensorflow.keras import losses;from tensorflow.keras import utils;import tensorflow as tf;import tensorflow_text as tf_text;import pathlib;import tensorflow_datasets as tfds;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import layers;import collections', function_to_run='obj.summary()', method_object=eval('model'), function_args=[], function_kwargs={}, max_wait_secs=0, custom_class=None)
custom_method(
