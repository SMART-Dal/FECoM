...
tf.keras.utils.get_file('aclImdb_v1.tar.gz', url, untar=True, cache_dir='.', cache_subdir=''), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='tf.keras.utils.get_file(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('"aclImdb_v1.tar.gz"'), eval('url')], function_kwargs={'untar': eval('True'), 'cache_dir': eval('"."'), 'cache_subdir': eval('""')})
...
Embedding(vectorize_layer_new.vocabulary_size(), embedding_dim, name='embedding'), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='Embedding(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('vectorize_layer_new.vocabulary_size()'), eval('embedding_dim')], function_kwargs={'name': eval('"embedding"')})
custom_method(
text_embedding_layer_new.build(input_shape=[None]), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='obj.build(**kwargs)', method_object=eval('text_embedding_layer_new'), object_signature=None, function_args=[], function_kwargs={'input_shape': eval('[None]')}, custom_class=None)
custom_method(
text_embedding_layer_new.embeddings.assign(updated_embedding), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='obj.embeddings.assign(*args)', method_object=eval('text_embedding_layer_new'), object_signature=None, function_args=[eval('updated_embedding')], function_kwargs={}, custom_class=None)
text_input_new = custom_method(
tf.keras.Sequential([vectorize_layer_new, text_embedding_layer_new], name='text_input_new'), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='tf.keras.Sequential(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('[vectorize_layer_new, text_embedding_layer_new]')], function_kwargs={'name': eval('"text_input_new"')})
custom_method(
text_input_new.summary(), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='obj.summary()', method_object=eval('text_input_new'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
custom_method(
text_input_new.get_layer('embedding').get_weights(), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run="obj.get_layer('embedding').get_weights()", method_object=eval('text_input_new'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)[0].shape
warm_started_model = custom_method(
tf.keras.Sequential([text_input_new, classifier_head]), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='tf.keras.Sequential(*args)', method_object=None, object_signature=None, function_args=[eval('[text_input_new, classifier_head]')], function_kwargs={})
custom_method(
warm_started_model.summary(), imports='import os;from tensorflow.keras.layers import TextVectorization;import io;from tensorflow.keras.layers import Dense, Embedding, GlobalAveragePooling1D;from tensorflow.keras import Model;import re;import tensorflow as tf;import string;import numpy as np;import shutil', function_to_run='obj.summary()', method_object=eval('warm_started_model'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
