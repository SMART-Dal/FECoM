...
seed = 42
custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.random.set_seed(*args)', method_object=None, object_signature=None, function_args=[eval('seed')], function_kwargs={})
...
class ActorCritic(tf.keras.Model):
    ...
    def __init__(self, num_actions: int, num_hidden_units: int):
        """Initialize."""
        super().__init__()
        custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='layers.Dense(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('num_hidden_units')], function_kwargs={'activation': eval('"relu"')})
        self.common = layers.Dense(num_hidden_units, activation='relu')
        custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='layers.Dense(*args)', method_object=None, object_signature=None, function_args=[eval('num_actions')], function_kwargs={})
...
def run_episode(initial_state: tf.Tensor, model: tf.keras.Model, max_steps: int) -> Tuple[tf.Tensor, tf.Tensor, tf.Tensor]:
    ...
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.TensorArray(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'dtype': eval('tf.float32'), 'size': eval('0'), 'dynamic_size': eval('True')})
    action_probs = tf.TensorArray(dtype=tf.float32, size=0, dynamic_size=True)
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.TensorArray(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'dtype': eval('tf.float32'), 'size': eval('0'), 'dynamic_size': eval('True')})
    values = tf.TensorArray(dtype=tf.float32, size=0, dynamic_size=True)
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.TensorArray(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'dtype': eval('tf.int32'), 'size': eval('0'), 'dynamic_size': eval('True')})
    rewards = tf.TensorArray(dtype=tf.int32, size=0, dynamic_size=True)
    initial_state_shape = initial_state.shape
    state = initial_state
    for t in tf.range(max_steps):
        custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.expand_dims(*args)', method_object=None, object_signature=None, function_args=[eval('state'), eval('0')], function_kwargs={})
        ...
        custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='obj.set_shape(*args)', method_object=eval('state'), object_signature=None, function_args=[eval('initial_state_shape')], function_kwargs={}, custom_class=None)
        state.set_shape(initial_state_shape)
        custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='obj.write(*args)', method_object=eval('rewards'), object_signature=None, function_args=[eval('t'), eval('reward')], function_kwargs={}, custom_class=None)
        rewards = rewards.write(t, reward)
        if tf.cast(done, tf.bool):
            break
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='obj.stack()', method_object=eval('action_probs'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
    action_probs = action_probs.stack()
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='obj.stack()', method_object=eval('values'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
    values = values.stack()
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='obj.stack()', method_object=eval('rewards'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
...
def get_expected_return(rewards: tf.Tensor, gamma: float, standardize: bool=True) -> tf.Tensor:
    ...
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.TensorArray(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'dtype': eval('tf.float32'), 'size': eval('n')})
    returns = tf.TensorArray(dtype=tf.float32, size=n)
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.cast(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('rewards[::-1]')], function_kwargs={'dtype': eval('tf.float32')})
    rewards = tf.cast(rewards[::-1], dtype=tf.float32)
    custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.constant(*args)', method_object=None, object_signature=None, function_args=[eval('0.0')], function_kwargs={})
    ...
    return returns
custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.keras.losses.Huber(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'reduction': eval('tf.keras.losses.Reduction.SUM')})
...
custom_method(imports='from typing import Any, List, Sequence, Tuple;import tensorflow as tf;import statistics;from matplotlib import pyplot as plt;import tqdm;import numpy as np;from tensorflow.keras import layers;from IPython import display as ipythondisplay;import collections;import gym;from PIL import Image;import tensorflow_docs.vis.embed as embed', function_to_run='tf.keras.optimizers.Adam(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'learning_rate': eval('0.01')})
