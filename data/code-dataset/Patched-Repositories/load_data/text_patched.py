...
utils.text_dataset_from_directory(train_dir, batch_size=batch_size, validation_split=0.2, subset='training', seed=seed), imports='from tensorflow.keras import layers;import tensorflow as tf;import tensorflow_text as tf_text;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import pathlib;import collections;import tensorflow_datasets as tfds;from tensorflow.keras import utils', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'training'"), 'seed': eval('seed')}, max_wait_secs=0)
...
create_model(vocab_size=VOCAB_SIZE + 1, num_labels=4), imports='from tensorflow.keras import layers;import tensorflow as tf;import tensorflow_text as tf_text;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import pathlib;import collections;import tensorflow_datasets as tfds;from tensorflow.keras import utils', function_to_run='obj(**kwargs)', method_object=eval('create_model'), function_args=[], function_kwargs={'vocab_size': eval('VOCAB_SIZE + 1'), 'num_labels': eval('4')}, max_wait_secs=0, custom_class=None)
custom_method(
int_model.compile(loss=losses.SparseCategoricalCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy']), imports='from tensorflow.keras import layers;import tensorflow as tf;import tensorflow_text as tf_text;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import pathlib;import collections;import tensorflow_datasets as tfds;from tensorflow.keras import utils', function_to_run='obj.compile(**kwargs)', method_object=eval('int_model'), function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, max_wait_secs=0, custom_class=None)
history = custom_method(
int_model.fit(int_train_ds, validation_data=int_val_ds, epochs=5), imports='from tensorflow.keras import layers;import tensorflow as tf;import tensorflow_text as tf_text;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import pathlib;import collections;import tensorflow_datasets as tfds;from tensorflow.keras import utils', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('int_model'), function_args=[eval('int_train_ds')], function_kwargs={'validation_data': eval('int_val_ds'), 'epochs': eval('5')}, max_wait_secs=0, custom_class=None)
...
def get_string_labels(predicted_scores_batch):
    ...
    tf.math.argmax(predicted_scores_batch, axis=1), imports='from tensorflow.keras import layers;import tensorflow as tf;import tensorflow_text as tf_text;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import pathlib;import collections;import tensorflow_datasets as tfds;from tensorflow.keras import utils', function_to_run='tf.math.argmax(*args, **kwargs)', method_object=None, function_args=[eval('predicted_scores_batch')], function_kwargs={'axis': eval('1')}, max_wait_secs=0)
...
model = custom_method(
create_model(vocab_size=VOCAB_SIZE + 1, num_labels=1), imports='from tensorflow.keras import layers;import tensorflow as tf;import tensorflow_text as tf_text;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import pathlib;import collections;import tensorflow_datasets as tfds;from tensorflow.keras import utils', function_to_run='obj(**kwargs)', method_object=eval('create_model'), function_args=[], function_kwargs={'vocab_size': eval('VOCAB_SIZE + 1'), 'num_labels': eval('1')}, max_wait_secs=0, custom_class=None)
custom_method(
model.summary(), imports='from tensorflow.keras import layers;import tensorflow as tf;import tensorflow_text as tf_text;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import pathlib;import collections;import tensorflow_datasets as tfds;from tensorflow.keras import utils', function_to_run='obj.summary()', method_object=eval('model'), function_args=[], function_kwargs={}, max_wait_secs=0, custom_class=None)
custom_method(
