...
utils.get_file(origin=data_url, untar=True, cache_dir='stack_overflow', cache_subdir=''), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='utils.get_file(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'origin': eval('data_url'), 'untar': eval('True'), 'cache_dir': eval("'stack_overflow'"), 'cache_subdir': eval("''")})
...
utils.text_dataset_from_directory(train_dir, batch_size=batch_size, validation_split=0.2, subset='training', seed=seed), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'training'"), 'seed': eval('seed')})
for (text_batch, label_batch) in custom_method(
raw_train_ds.take(1), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.take(*args)', method_object=eval('raw_train_ds'), object_signature=None, function_args=[eval('1')], function_kwargs={}, custom_class=None):
    for i in range(10):
...
utils.text_dataset_from_directory(train_dir, batch_size=batch_size, validation_split=0.2, subset='validation', seed=seed), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'validation'"), 'seed': eval('seed')})
test_dir = dataset_dir / 'test'
raw_test_ds = custom_method(
utils.text_dataset_from_directory(test_dir, batch_size=batch_size), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('test_dir')], function_kwargs={'batch_size': eval('batch_size')})
VOCAB_SIZE = 10000
binary_vectorize_layer = custom_method(
TextVectorization(max_tokens=VOCAB_SIZE, output_mode='binary'), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='TextVectorization(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'max_tokens': eval('VOCAB_SIZE'), 'output_mode': eval("'binary'")})
...
def binary_vectorize_text(text, label):
    text = custom_method(
    tf.expand_dims(text, -1), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='tf.expand_dims(*args)', method_object=None, object_signature=None, function_args=[eval('text'), eval('-1')], function_kwargs={})
    return (custom_method(
    binary_vectorize_layer(text), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj(*args)', method_object=eval('binary_vectorize_layer'), object_signature=None, function_args=[eval('text')], function_kwargs={}, custom_class=None), label)

def int_vectorize_text(text, label):
    text = custom_method(
    tf.expand_dims(text, -1), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='tf.expand_dims(*args)', method_object=None, object_signature=None, function_args=[eval('text'), eval('-1')], function_kwargs={})
    return (custom_method(
    int_vectorize_layer(text), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj(*args)', method_object=eval('int_vectorize_layer'), object_signature=None, function_args=[eval('text')], function_kwargs={}, custom_class=None), label)
...
tf.keras.Sequential([layers.Dense(4)]), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='tf.keras.Sequential(*args)', method_object=None, object_signature=None, function_args=[eval('[layers.Dense(4)]')], function_kwargs={})
custom_method(
binary_model.compile(loss=losses.SparseCategoricalCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy']), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.compile(**kwargs)', method_object=eval('binary_model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
history = custom_method(
binary_model.fit(binary_train_ds, validation_data=binary_val_ds, epochs=10), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('binary_model'), object_signature=None, function_args=[eval('binary_train_ds')], function_kwargs={'validation_data': eval('binary_val_ds'), 'epochs': eval('10')}, custom_class=None)
...
custom_method(
export_model.compile(loss=losses.SparseCategoricalCrossentropy(from_logits=False), optimizer='adam', metrics=['accuracy']), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.compile(**kwargs)', method_object=eval('export_model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=False)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
...
custom_method(
model.compile(optimizer='adam', loss=losses.SparseCategoricalCrossentropy(from_logits=True), metrics=['accuracy']), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'optimizer': eval("'adam'"), 'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'metrics': eval("['accuracy']")}, custom_class=None)
history = custom_method(
model.fit(train_data, validation_data=validation_data, epochs=3), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('model'), object_signature=None, function_args=[eval('train_data')], function_kwargs={'validation_data': eval('validation_data'), 'epochs': eval('3')}, custom_class=None)
(loss, accuracy) = custom_method(
...
export_model.predict(inputs), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.predict(*args)', method_object=eval('export_model'), object_signature=None, function_args=[eval('inputs')], function_kwargs={}, custom_class=None)
predicted_labels = custom_method(
tf.math.argmax(predicted_scores, axis=1), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='tf.math.argmax(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('predicted_scores')], function_kwargs={'axis': eval('1')})
for (input, label) in zip(inputs, predicted_labels):
    print('Question: ', input)
    print('Predicted label: ', label.numpy())
...
custom_method(
model.summary(), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.summary()', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
custom_method(
model.compile(loss=losses.BinaryCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy']), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.BinaryCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
history = custom_method(
model.fit(train_ds, validation_data=val_ds, epochs=3), imports='from tensorflow.keras import layers;import pathlib;from tensorflow.keras import losses;from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;import tensorflow as tf;import collections;from tensorflow.keras import utils;import tensorflow_datasets as tfds', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('model'), object_signature=None, function_args=[eval('train_ds')], function_kwargs={'validation_data': eval('val_ds'), 'epochs': eval('3')}, custom_class=None)
(loss, accuracy) = custom_method(
