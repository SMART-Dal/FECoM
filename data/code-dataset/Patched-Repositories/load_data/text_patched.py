...
custom_method(imports='from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;from tensorflow.keras import layers;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import pathlib;from tensorflow.keras import utils;import collections;import tensorflow as tf', function_to_run='obj.compile(**kwargs)', method_object=eval('binary_model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
binary_model.compile(loss=losses.SparseCategoricalCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy'])
custom_method(imports='from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;from tensorflow.keras import layers;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import pathlib;from tensorflow.keras import utils;import collections;import tensorflow as tf', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('binary_model'), object_signature=None, function_args=[eval('binary_train_ds')], function_kwargs={'validation_data': eval('binary_val_ds'), 'epochs': eval('10')}, custom_class=None)
...
custom_method(imports='from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;from tensorflow.keras import layers;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import pathlib;from tensorflow.keras import utils;import collections;import tensorflow as tf', function_to_run='obj.compile(**kwargs)', method_object=eval('export_model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=False)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
...
custom_method(imports='from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;from tensorflow.keras import layers;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import pathlib;from tensorflow.keras import utils;import collections;import tensorflow as tf', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'optimizer': eval("'adam'"), 'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'metrics': eval("['accuracy']")}, custom_class=None)
model.compile(optimizer='adam', loss=losses.SparseCategoricalCrossentropy(from_logits=True), metrics=['accuracy'])
custom_method(imports='from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;from tensorflow.keras import layers;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import pathlib;from tensorflow.keras import utils;import collections;import tensorflow as tf', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('model'), object_signature=None, function_args=[eval('train_data')], function_kwargs={'validation_data': eval('validation_data'), 'epochs': eval('3')}, custom_class=None)
...
model.summary()
custom_method(imports='from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;from tensorflow.keras import layers;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import pathlib;from tensorflow.keras import utils;import collections;import tensorflow as tf', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.BinaryCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
model.compile(loss=losses.BinaryCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy'])
custom_method(imports='from tensorflow.keras.layers import TextVectorization;import tensorflow_text as tf_text;from tensorflow.keras import layers;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import pathlib;from tensorflow.keras import utils;import collections;import tensorflow as tf', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('model'), object_signature=None, function_args=[eval('train_ds')], function_kwargs={'validation_data': eval('val_ds'), 'epochs': eval('3')}, custom_class=None)
