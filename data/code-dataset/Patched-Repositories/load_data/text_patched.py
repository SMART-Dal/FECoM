...
utils.get_file(origin=data_url, untar=True, cache_dir='stack_overflow', cache_subdir=''), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='utils.get_file(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'origin': eval('data_url'), 'untar': eval('True'), 'cache_dir': eval("'stack_overflow'"), 'cache_subdir': eval("''")})
...
utils.text_dataset_from_directory(train_dir, batch_size=batch_size, validation_split=0.2, subset='training', seed=seed), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'training'"), 'seed': eval('seed')})
...
utils.text_dataset_from_directory(train_dir, batch_size=batch_size, validation_split=0.2, subset='validation', seed=seed), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'validation'"), 'seed': eval('seed')})
test_dir = dataset_dir / 'test'
raw_test_ds = custom_method(
utils.text_dataset_from_directory(test_dir, batch_size=batch_size), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('test_dir')], function_kwargs={'batch_size': eval('batch_size')})
VOCAB_SIZE = 10000
binary_vectorize_layer = custom_method(
TextVectorization(max_tokens=VOCAB_SIZE, output_mode='binary'), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='TextVectorization(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'max_tokens': eval('VOCAB_SIZE'), 'output_mode': eval("'binary'")})
...
def binary_vectorize_text(text, label):
    text = custom_method(
    tf.expand_dims(text, -1), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='tf.expand_dims(*args)', method_object=None, object_signature=None, function_args=[eval('text'), eval('-1')], function_kwargs={})
...
def get_string_labels(predicted_scores_batch):
    ...
    tf.math.argmax(predicted_scores_batch, axis=1), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='tf.math.argmax(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('predicted_scores_batch')], function_kwargs={'axis': eval('1')})
    predicted_labels = custom_method(
    tf.gather(raw_train_ds.class_names, predicted_int_labels), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='tf.gather(*args)', method_object=None, object_signature=None, function_args=[eval('raw_train_ds.class_names'), eval('predicted_int_labels')], function_kwargs={})
...
for name in FILE_NAMES:
    ...
    utils.get_file(name, origin=DIRECTORY_URL + name), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='utils.get_file(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('name')], function_kwargs={'origin': eval('DIRECTORY_URL + name')})
parent_dir = pathlib.Path(text_dir).parent
list(parent_dir.iterdir())

def labeler(example, index):
    return (example, custom_method(
    tf.cast(index, tf.int64), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='tf.cast(*args)', method_object=None, object_signature=None, function_args=[eval('index'), eval('tf.int64')], function_kwargs={}))
labeled_data_sets = []
for (i, file_name) in enumerate(FILE_NAMES):
    lines_dataset = custom_method(
    tf.data.TextLineDataset(str(parent_dir / file_name)), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='tf.data.TextLineDataset(*args)', method_object=None, object_signature=None, function_args=[eval('str(parent_dir/file_name)')], function_kwargs={})
...
predicted_scores = export_model.predict(inputs)
predicted_labels = custom_method(
tf.math.argmax(predicted_scores, axis=1), imports='from tensorflow.keras import layers;import collections;from tensorflow.keras import utils;import tensorflow as tf;from tensorflow.keras.layers import TextVectorization;import tensorflow_datasets as tfds;from tensorflow.keras import losses;import tensorflow_text as tf_text;import pathlib', function_to_run='tf.math.argmax(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('predicted_scores')], function_kwargs={'axis': eval('1')})
for (input, label) in zip(inputs, predicted_labels):
    print('Question: ', input)
    print('Predicted label: ', label.numpy())
