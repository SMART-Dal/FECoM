...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='utils.get_file(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'origin': eval('data_url'), 'untar': eval('True'), 'cache_dir': eval("'stack_overflow'"), 'cache_subdir': eval("''")})
...
batch_size = 32
seed = 42
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'training'"), 'seed': eval('seed')})
...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('train_dir')], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'validation'"), 'seed': eval('seed')})
...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('test_dir')], function_kwargs={'batch_size': eval('batch_size')})
raw_test_ds = utils.text_dataset_from_directory(test_dir, batch_size=batch_size)
VOCAB_SIZE = 10000
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='TextVectorization(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'max_tokens': eval('VOCAB_SIZE'), 'output_mode': eval("'binary'")})
...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.compile(**kwargs)', method_object=eval('binary_model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
binary_model.compile(loss=losses.SparseCategoricalCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy'])
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('binary_model'), object_signature=None, function_args=[eval('binary_train_ds')], function_kwargs={'validation_data': eval('binary_val_ds'), 'epochs': eval('10')}, custom_class=None)
...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.compile(**kwargs)', method_object=eval('export_model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=False)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
...
def get_string_labels(predicted_scores_batch):
    custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='tf.math.argmax(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('predicted_scores_batch')], function_kwargs={'axis': eval('1')})
...
for name in FILE_NAMES:
    custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='utils.get_file(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('name')], function_kwargs={'origin': eval('DIRECTORY_URL + name')})
...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'optimizer': eval("'adam'"), 'loss': eval('losses.SparseCategoricalCrossentropy(from_logits=True)'), 'metrics': eval("['accuracy']")}, custom_class=None)
model.compile(optimizer='adam', loss=losses.SparseCategoricalCrossentropy(from_logits=True), metrics=['accuracy'])
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('model'), object_signature=None, function_args=[eval('train_data')], function_kwargs={'validation_data': eval('validation_data'), 'epochs': eval('3')}, custom_class=None)
...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.predict(*args)', method_object=eval('export_model'), object_signature=None, function_args=[eval('inputs')], function_kwargs={}, custom_class=None)
predicted_scores = export_model.predict(inputs)
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='tf.math.argmax(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('predicted_scores')], function_kwargs={'axis': eval('1')})
...
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.summary()', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
model.summary()
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.BinaryCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval("['accuracy']")}, custom_class=None)
model.compile(loss=losses.BinaryCrossentropy(from_logits=True), optimizer='adam', metrics=['accuracy'])
custom_method(imports='from tensorflow.keras import layers;import tensorflow as tf;from tensorflow.keras import utils;from tensorflow.keras.layers import TextVectorization;from tensorflow.keras import losses;import tensorflow_text as tf_text;import tensorflow_datasets as tfds;import pathlib;import collections', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('model'), object_signature=None, function_args=[eval('train_ds')], function_kwargs={'validation_data': eval('val_ds'), 'epochs': eval('3')}, custom_class=None)
