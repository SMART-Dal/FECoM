...
def serialize_example(feature0, feature1, feature2, feature3):
  ...
  """
    ...
    tf.train.Example(features=tf.train.Features(feature=feature)), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.train.Example(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'features': eval('tf.train.Features(feature=feature)')})
    return example_proto.SerializeToString()
example_observation = []
serialized_example = serialize_example(False, 4, b'goat', 0.9876)
serialized_example
example_proto = custom_method(
tf.train.Example.FromString(serialized_example), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.train.Example.FromString(*args)', method_object=None, object_signature=None, function_args=[eval('serialized_example')], function_kwargs={})
example_proto
custom_method(
tf.data.Dataset.from_tensor_slices(feature1), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.data.Dataset.from_tensor_slices(*args)', method_object=None, object_signature=None, function_args=[eval('feature1')], function_kwargs={})
...
def tf_serialize_example(f0, f1, f2, f3):
    ...
    tf.py_function(serialize_example, (f0, f1, f2, f3), tf.string), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.py_function(*args)', method_object=None, object_signature=None, function_args=[eval('serialize_example'), eval('(f0, f1, f2, f3)'), eval('tf.string')], function_kwargs={})
    return custom_method(
    tf.reshape(tf_string, ()), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.reshape(*args)', method_object=None, object_signature=None, function_args=[eval('tf_string'), eval('()')], function_kwargs={})
...
tf.data.experimental.TFRecordWriter(filename), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.data.experimental.TFRecordWriter(*args)', method_object=None, object_signature=None, function_args=[eval('filename')], function_kwargs={})
writer.write(serialized_features_dataset)
filenames = [filename]
raw_dataset = custom_method(
tf.data.TFRecordDataset(filenames), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.data.TFRecordDataset(*args)', method_object=None, object_signature=None, function_args=[eval('filenames')], function_kwargs={})
raw_dataset
...
with custom_method(
tf.io.TFRecordWriter(filename), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.io.TFRecordWriter(*args)', method_object=None, object_signature=None, function_args=[eval('filename')], function_kwargs={}) as writer:
...
for raw_record in raw_dataset.take(1):
    ...
    tf.train.Example(), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.train.Example()', method_object=None, object_signature=None, function_args=[], function_kwargs={})
...
with custom_method(
tf.io.TFRecordWriter(record_file), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.io.TFRecordWriter(*args)', method_object=None, object_signature=None, function_args=[eval('record_file')], function_kwargs={}) as writer:
    for (filename, label) in image_labels.items():
        image_string = open(filename, 'rb').read()
        tf_example = image_example(image_string, label)
        writer.write(tf_example.SerializeToString())
raw_image_dataset = custom_method(
tf.data.TFRecordDataset('images.tfrecords'), imports='import IPython.display as display;import numpy as np;import tensorflow as tf', function_to_run='tf.data.TFRecordDataset(*args)', method_object=None, object_signature=None, function_args=[eval("'images.tfrecords'")], function_kwargs={})
