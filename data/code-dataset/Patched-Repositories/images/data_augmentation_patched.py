...
IMG_SIZE = 180
custom_method(imports='import tensorflow_datasets as tfds;from tensorflow.keras import layers;import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.keras.Sequential(*args)', method_object=None, object_signature=None, function_args=[eval('[\n  layers.Resizing(IMG_SIZE, IMG_SIZE),\n  layers.Rescaling(1./255)\n]')], function_kwargs={})
resize_and_rescale = tf.keras.Sequential([layers.Resizing(IMG_SIZE, IMG_SIZE), layers.Rescaling(1.0 / 255)])
custom_method(imports='import tensorflow_datasets as tfds;from tensorflow.keras import layers;import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='obj(*args)', method_object=eval('resize_and_rescale'), object_signature=None, function_args=[eval('image')], function_kwargs={}, custom_class=None)
...
custom_method(imports='import tensorflow_datasets as tfds;from tensorflow.keras import layers;import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.image.flip_left_right(*args)', method_object=None, object_signature=None, function_args=[eval('image')], function_kwargs={})
flipped = tf.image.flip_left_right(image)
visualize(image, flipped)
custom_method(imports='import tensorflow_datasets as tfds;from tensorflow.keras import layers;import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.image.rgb_to_grayscale(*args)', method_object=None, object_signature=None, function_args=[eval('image')], function_kwargs={})
...
custom_method(imports='import tensorflow_datasets as tfds;from tensorflow.keras import layers;import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.image.rot90(*args)', method_object=None, object_signature=None, function_args=[eval('image')], function_kwargs={})
...
def resize_and_rescale(image, label):
    custom_method(imports='import tensorflow_datasets as tfds;from tensorflow.keras import layers;import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.cast(*args)', method_object=None, object_signature=None, function_args=[eval('image'), eval('tf.float32')], function_kwargs={})
...
def augment(image_label, seed):
    ...
    return (image, label)
custom_method(imports='import tensorflow_datasets as tfds;from tensorflow.keras import layers;import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='tf.data.experimental.Counter()', method_object=None, object_signature=None, function_args=[], function_kwargs={})
