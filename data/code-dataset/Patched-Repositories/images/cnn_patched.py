...
datasets.cifar10.load_data(), imports='import matplotlib.pyplot as plt;import tensorflow as tf;from tensorflow.keras import datasets, layers, models', function_to_run='datasets.cifar10.load_data()', method_object=None, object_signature=None, function_args=[], function_kwargs={}, max_wait_secs=0)
...
plt.show()
model = custom_method(
models.Sequential(), imports='import matplotlib.pyplot as plt;import tensorflow as tf;from tensorflow.keras import datasets, layers, models', function_to_run='models.Sequential()', method_object=None, object_signature=None, function_args=[], function_kwargs={}, max_wait_secs=0)
custom_method(
...
model.add(layers.Conv2D(64, (3, 3), activation='relu')), imports='import matplotlib.pyplot as plt;import tensorflow as tf;from tensorflow.keras import datasets, layers, models', function_to_run='obj.add(*args)', method_object=eval('model'), object_signature='models.Sequential', function_args=[eval("layers.Conv2D(64, (3, 3), activation='relu')")], function_kwargs={}, max_wait_secs=0, custom_class=None)
custom_method(
model.summary(), imports='import matplotlib.pyplot as plt;import tensorflow as tf;from tensorflow.keras import datasets, layers, models', function_to_run='obj.summary()', method_object=eval('model'), object_signature='models.Sequential', function_args=[], function_kwargs={}, max_wait_secs=0, custom_class=None)
custom_method(
model.add(layers.Flatten()), imports='import matplotlib.pyplot as plt;import tensorflow as tf;from tensorflow.keras import datasets, layers, models', function_to_run='obj.add(*args)', method_object=eval('model'), object_signature='models.Sequential', function_args=[eval('layers.Flatten()')], function_kwargs={}, max_wait_secs=0, custom_class=None)
custom_method(
