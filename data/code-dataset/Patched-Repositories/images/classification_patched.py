...
custom_method(imports='from tensorflow.keras import layers;import PIL;from tensorflow.keras.models import Sequential;import matplotlib.pyplot as plt;from tensorflow import keras;import pathlib;import numpy as np;import tensorflow as tf', function_to_run='obj.cache().shuffle(1000).prefetch(**kwargs)', method_object=eval('train_ds'), object_signature=None, function_args=[], function_kwargs={'buffer_size': eval('AUTOTUNE')}, custom_class=None)
...
custom_method(imports='from tensorflow.keras import layers;import PIL;from tensorflow.keras.models import Sequential;import matplotlib.pyplot as plt;from tensorflow import keras;import pathlib;import numpy as np;import tensorflow as tf', function_to_run='obj.convert()', method_object=eval('converter'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
