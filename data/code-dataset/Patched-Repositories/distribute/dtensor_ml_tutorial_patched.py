...
def configure_virtual_cpus(ncpu):
    custom_method(imports='from typing import Tuple;import tensorflow_datasets as tfds;import tensorflow as tf;import numpy as np;import tempfile;from tensorflow.experimental import dtensor', function_to_run='tf.config.list_physical_devices(*args)', method_object=None, object_signature=None, function_args=[eval("'CPU'")], function_kwargs={})
...
custom_method(imports='from typing import Tuple;import tensorflow_datasets as tfds;import tensorflow as tf;import numpy as np;import tempfile;from tensorflow.experimental import dtensor', function_to_run='tf.keras.Sequential(*args)', method_object=None, object_signature=None, function_args=[eval('[\n  text_vectorization,\n  mlp\n]')], function_kwargs={})
