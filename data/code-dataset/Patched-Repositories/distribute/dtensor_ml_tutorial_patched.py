...
custom_method(imports='import numpy as np;import tempfile;import tensorflow_datasets as tfds;import tensorflow as tf;from typing import Tuple;from tensorflow.experimental import dtensor', function_to_run='tf.keras.Sequential(*args)', method_object=None, object_signature=None, function_args=[eval('[\n  text_vectorization,\n  mlp\n]')], function_kwargs={})
