...
custom_method(
model.compile(loss=tf.keras.losses.SparseCategoricalCrossentropy(from_logits=True), optimizer='adam'), imports='import numpy as np;import tempfile;import tensorflow as tf;import tensorflow_datasets as tfds', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('tf.keras.losses.SparseCategoricalCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'")}, custom_class=None)
custom_method(
model.summary(), imports='import numpy as np;import tempfile;import tensorflow as tf;import tensorflow_datasets as tfds', function_to_run='obj.summary()', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={}, custom_class=None)
...
custom_method(
keras_estimator.train(input_fn=input_fn, steps=500), imports='import numpy as np;import tempfile;import tensorflow as tf;import tensorflow_datasets as tfds', function_to_run='obj.train(**kwargs)', method_object=eval('keras_estimator'), object_signature=None, function_args=[], function_kwargs={'input_fn': eval('input_fn'), 'steps': eval('500')}, custom_class=None)
eval_result = custom_method(
keras_estimator.evaluate(input_fn=input_fn, steps=10), imports='import numpy as np;import tempfile;import tensorflow as tf;import tensorflow_datasets as tfds', function_to_run='obj.evaluate(**kwargs)', method_object=eval('keras_estimator'), object_signature=None, function_args=[], function_kwargs={'input_fn': eval('input_fn'), 'steps': eval('10')}, custom_class=None)
