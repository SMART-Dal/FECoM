...
class DeepResNet(tf.keras.Model):
    ...
    def __init__(self, num_classes, num_layers=3, num_hidden=128, dropout_rate=0.1, **classifier_kwargs):
        ...
        custom_method(imports='import numpy as np;import tensorflow as tf;import pkg_resources;import official.nlp.modeling.layers as nlp_layers;import matplotlib.pyplot as plt;import importlib;import sklearn.datasets;import matplotlib.colors as colors', function_to_run='tf.keras.layers.Dense(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('self.num_hidden')], function_kwargs={'trainable': eval('False')})
