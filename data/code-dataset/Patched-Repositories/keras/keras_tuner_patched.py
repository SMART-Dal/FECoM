...
keras.datasets.fashion_mnist.load_data(), imports='import keras_tuner as kt;from tensorflow import keras;import tensorflow as tf', function_to_run='keras.datasets.fashion_mnist.load_data()', method_object=None, object_signature=None, function_args=[], function_kwargs={}, max_wait_secs=0)
img_train = img_train.astype('float32') / 255.0
img_test = img_test.astype('float32') / 255.0

def model_builder(hp):
    model = custom_method(
    keras.Sequential(), imports='import keras_tuner as kt;from tensorflow import keras;import tensorflow as tf', function_to_run='keras.Sequential()', method_object=None, object_signature=None, function_args=[], function_kwargs={}, max_wait_secs=0)
    custom_method(
    model.add(keras.layers.Flatten(input_shape=(28, 28))), imports='import keras_tuner as kt;from tensorflow import keras;import tensorflow as tf', function_to_run='obj.add(*args)', method_object=eval('model'), object_signature='keras.Sequential', function_args=[eval('keras.layers.Flatten(input_shape=(28, 28))')], function_kwargs={}, max_wait_secs=0, custom_class=None)
    ...
    custom_method(
    model.add(keras.layers.Dense(10)), imports='import keras_tuner as kt;from tensorflow import keras;import tensorflow as tf', function_to_run='obj.add(*args)', method_object=eval('model'), object_signature='keras.Sequential', function_args=[eval('keras.layers.Dense(10)')], function_kwargs={}, max_wait_secs=0, custom_class=None)
...
tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=5), imports='import keras_tuner as kt;from tensorflow import keras;import tensorflow as tf', function_to_run='tf.keras.callbacks.EarlyStopping(**kwargs)', method_object=None, object_signature=None, function_args=[], function_kwargs={'monitor': eval("'val_loss'"), 'patience': eval('5')}, max_wait_secs=0)
...
custom_method(
hypermodel.fit(img_train, label_train, epochs=best_epoch, validation_split=0.2), imports='import keras_tuner as kt;from tensorflow import keras;import tensorflow as tf', function_to_run='obj.fit(*args, **kwargs)', method_object=eval('hypermodel'), object_signature='keras.Sequential', function_args=[eval('img_train'), eval('label_train')], function_kwargs={'epochs': eval('best_epoch'), 'validation_split': eval('0.2')}, max_wait_secs=0, custom_class=None)
eval_result = custom_method(
hypermodel.evaluate(img_test, label_test), imports='import keras_tuner as kt;from tensorflow import keras;import tensorflow as tf', function_to_run='obj.evaluate(*args)', method_object=eval('hypermodel'), object_signature='keras.Sequential', function_args=[eval('img_test'), eval('label_test')], function_kwargs={}, max_wait_secs=0, custom_class=None)
