...
keras.datasets.fashion_mnist.load_data(), imports='from tensorflow import keras;import tensorflow as tf;import keras_tuner as kt', function_to_run='keras.datasets.fashion_mnist.load_data()', method_object=None, object_signature=None, function_args=[], function_kwargs={})
