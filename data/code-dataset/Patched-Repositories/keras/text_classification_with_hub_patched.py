...
model = custom_method(
tf.keras.Sequential(), imports='import numpy as np;import os;import tensorflow_hub as hub;import tensorflow_datasets as tfds;import tensorflow as tf', function_to_run='tf.keras.Sequential()', method_object=None, function_args=[], function_kwargs={}, max_wait_secs=0)
custom_method(
model.add(hub_layer), imports='import numpy as np;import os;import tensorflow_hub as hub;import tensorflow_datasets as tfds;import tensorflow as tf', function_to_run='obj.add(*args)', method_object=eval('model'), function_args=[eval('hub_layer')], function_kwargs={}, max_wait_secs=0, custom_class=None)
custom_method(
...
custom_method(
model.summary(), imports='import numpy as np;import os;import tensorflow_hub as hub;import tensorflow_datasets as tfds;import tensorflow as tf', function_to_run='obj.summary()', method_object=eval('model'), function_args=[], function_kwargs={}, max_wait_secs=0, custom_class=None)
custom_method(
