...
probability_model.predict(test_images), imports='import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='obj.predict(*args)', method_object=eval('probability_model'), object_signature='tf.keras.Sequential', function_args=[eval('test_images')], function_kwargs={}, max_wait_secs=0, custom_class=None)
predictions[0]
...
probability_model.predict(img), imports='import numpy as np;import matplotlib.pyplot as plt;import tensorflow as tf', function_to_run='obj.predict(*args)', method_object=eval('probability_model'), object_signature='tf.keras.Sequential', function_args=[eval('img')], function_kwargs={}, max_wait_secs=0, custom_class=None)
