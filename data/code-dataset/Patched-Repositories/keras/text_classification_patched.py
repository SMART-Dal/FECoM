...
tf.keras.utils.get_file('aclImdb_v1', url, untar=True, cache_dir='.', cache_subdir=''), imports='import shutil;import tensorflow as tf;import string;import re;from tensorflow.keras import losses;import matplotlib.pyplot as plt;from tensorflow.keras import layers;import os', function_to_run='tf.keras.utils.get_file(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval('"aclImdb_v1"'), eval('url')], function_kwargs={'untar': eval('True'), 'cache_dir': eval("'.'"), 'cache_subdir': eval("''")})
...
tf.keras.utils.text_dataset_from_directory('aclImdb/train', batch_size=batch_size, validation_split=0.2, subset='training', seed=seed), imports='import shutil;import tensorflow as tf;import string;import re;from tensorflow.keras import losses;import matplotlib.pyplot as plt;from tensorflow.keras import layers;import os', function_to_run='tf.keras.utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval("'aclImdb/train'")], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'training'"), 'seed': eval('seed')})
