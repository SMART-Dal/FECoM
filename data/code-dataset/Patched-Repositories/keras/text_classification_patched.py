...
custom_method(imports='import os;import string;from tensorflow.keras import layers;import re;import shutil;import matplotlib.pyplot as plt;from tensorflow.keras import losses;import tensorflow as tf', function_to_run='tf.keras.utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval("'aclImdb/test'")], function_kwargs={'batch_size': eval('batch_size')})
...
embedding_dim = 16
custom_method(imports='import os;import string;from tensorflow.keras import layers;import re;import shutil;import matplotlib.pyplot as plt;from tensorflow.keras import losses;import tensorflow as tf', function_to_run='tf.keras.Sequential(*args)', method_object=None, object_signature=None, function_args=[eval('[\n  layers.Embedding(max_features + 1, embedding_dim),\n  layers.Dropout(0.2),\n  layers.GlobalAveragePooling1D(),\n  layers.Dropout(0.2),\n  layers.Dense(1)]')], function_kwargs={})
...
model.summary()
custom_method(imports='import os;import string;from tensorflow.keras import layers;import re;import shutil;import matplotlib.pyplot as plt;from tensorflow.keras import losses;import tensorflow as tf', function_to_run='obj.compile(**kwargs)', method_object=eval('model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.BinaryCrossentropy(from_logits=True)'), 'optimizer': eval("'adam'"), 'metrics': eval('tf.metrics.BinaryAccuracy(threshold=0.0)')}, custom_class=None)
...
custom_method(imports='import os;import string;from tensorflow.keras import layers;import re;import shutil;import matplotlib.pyplot as plt;from tensorflow.keras import losses;import tensorflow as tf', function_to_run='obj.compile(**kwargs)', method_object=eval('export_model'), object_signature=None, function_args=[], function_kwargs={'loss': eval('losses.BinaryCrossentropy(from_logits=False)'), 'optimizer': eval('"adam"'), 'metrics': eval("['accuracy']")}, custom_class=None)
