...
tf.keras.utils.text_dataset_from_directory('aclImdb/train', batch_size=batch_size, validation_split=0.2, subset='validation', seed=seed), imports='import shutil;import os;import tensorflow as tf;import matplotlib.pyplot as plt;from tensorflow.keras import layers;import string;from tensorflow.keras import losses;import re', function_to_run='tf.keras.utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval("'aclImdb/train'")], function_kwargs={'batch_size': eval('batch_size'), 'validation_split': eval('0.2'), 'subset': eval("'validation'"), 'seed': eval('seed')}, max_wait_secs=0)
raw_test_ds = custom_method(
tf.keras.utils.text_dataset_from_directory('aclImdb/test', batch_size=batch_size), imports='import shutil;import os;import tensorflow as tf;import matplotlib.pyplot as plt;from tensorflow.keras import layers;import string;from tensorflow.keras import losses;import re', function_to_run='tf.keras.utils.text_dataset_from_directory(*args, **kwargs)', method_object=None, object_signature=None, function_args=[eval("'aclImdb/test'")], function_kwargs={'batch_size': eval('batch_size')}, max_wait_secs=0)

def custom_standardization(input_data):
    lowercase = custom_method(
    tf.strings.lower(input_data), imports='import shutil;import os;import tensorflow as tf;import matplotlib.pyplot as plt;from tensorflow.keras import layers;import string;from tensorflow.keras import losses;import re', function_to_run='tf.strings.lower(*args)', method_object=None, object_signature=None, function_args=[eval('input_data')], function_kwargs={}, max_wait_secs=0)
    stripped_html = custom_method(
    tf.strings.regex_replace(lowercase, '<br />', ' '), imports='import shutil;import os;import tensorflow as tf;import matplotlib.pyplot as plt;from tensorflow.keras import layers;import string;from tensorflow.keras import losses;import re', function_to_run='tf.strings.regex_replace(*args)', method_object=None, object_signature=None, function_args=[eval('lowercase'), eval("'<br />'"), eval("' '")], function_kwargs={}, max_wait_secs=0)
