...
embedding_dim = 16
custom_method(imports='import string;import re;from tensorflow.keras import layers;import tensorflow as tf;import matplotlib.pyplot as plt;import os;from tensorflow.keras import losses;import shutil', function_to_run='tf.keras.Sequential(*args)', method_object=None, object_signature=None, function_args=[eval('[\n  layers.Embedding(max_features + 1, embedding_dim),\n  layers.Dropout(0.2),\n  layers.GlobalAveragePooling1D(),\n  layers.Dropout(0.2),\n  layers.Dense(1)]')], function_kwargs={})
