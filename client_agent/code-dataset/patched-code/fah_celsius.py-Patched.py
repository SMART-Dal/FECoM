        ...
        Assign(
            ...
            value=Call(
                ...
                keywords=[
                    keyword(
                        arg='imports',
                        value=Constant(value='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt')),
                    keyword(
                        arg='function_to_run',
...
tf.get_logger(), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='tf.get_logger()', method_object=None, function_args=[], function_kwargs={}, max_wait_secs=30)
custom_method(
logger.setLevel(logging.ERROR), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='obj.setLevel(*args)', method_object='logger', function_args=[eval('logging.ERROR')], function_kwargs={}, max_wait_secs=30, custom_class=None)
celsius_q = np.array([-40, -10, 0, 8, 15, 22, 38], dtype=float)
fahrenheit_a = np.array([-40, 14, 32, 46, 59, 72, 100], dtype=float)
for (i, c) in enumerate(celsius_q):
    print('{} degrees Celsius = {} degrees Fahrenheit'.format(c, fahrenheit_a[i]))
l0 = custom_method(
tf.keras.layers.Dense(units=1, input_shape=[1]), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='tf.keras.layers.Dense(**kwargs)', method_object=None, function_args=[], function_kwargs={'units': eval('1'), 'input_shape': eval('[1]')}, max_wait_secs=30)
model = custom_method(
tf.keras.Sequential([l0]), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='tf.keras.Sequential(*args)', method_object=None, function_args=[eval('[l0]')], function_kwargs={}, max_wait_secs=30)
custom_method(
model.compile(loss='mean_squared_error', optimizer=tf.keras.optimizers.Adam(0.1)), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='obj.compile(**kwargs)', method_object='model', function_args=[], function_kwargs={'loss': eval("'mean_squared_error'"), 'optimizer': eval('tf.keras.optimizers.Adam(0.1)')}, max_wait_secs=30, custom_class=None)
history = custom_method(
model.fit(celsius_q, fahrenheit_a, epochs=500, verbose=False), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='obj.fit(*args, **kwargs)', method_object='model', function_args=[eval('celsius_q'), eval('fahrenheit_a')], function_kwargs={'epochs': eval('500'), 'verbose': eval('False')}, max_wait_secs=30, custom_class=None)
...
l0 = custom_method(
tf.keras.layers.Dense(units=4, input_shape=[1]), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='tf.keras.layers.Dense(**kwargs)', method_object=None, function_args=[], function_kwargs={'units': eval('4'), 'input_shape': eval('[1]')}, max_wait_secs=30)
l1 = custom_method(
tf.keras.layers.Dense(units=4), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='tf.keras.layers.Dense(**kwargs)', method_object=None, function_args=[], function_kwargs={'units': eval('4')}, max_wait_secs=30)
l2 = custom_method(
tf.keras.layers.Dense(units=1), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='tf.keras.layers.Dense(**kwargs)', method_object=None, function_args=[], function_kwargs={'units': eval('1')}, max_wait_secs=30)
model = custom_method(
tf.keras.Sequential([l0, l1, l2]), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='tf.keras.Sequential(*args)', method_object=None, function_args=[eval('[l0, l1, l2]')], function_kwargs={}, max_wait_secs=30)
custom_method(
model.compile(loss='mean_squared_error', optimizer=tf.keras.optimizers.Adam(0.1)), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='obj.compile(**kwargs)', method_object='model', function_args=[], function_kwargs={'loss': eval("'mean_squared_error'"), 'optimizer': eval('tf.keras.optimizers.Adam(0.1)')}, max_wait_secs=30, custom_class=None)
custom_method(
model.fit(celsius_q, fahrenheit_a, epochs=500, verbose=False), imports='import tensorflow as tf;import numpy as np;import logging;import matplotlib.pyplot as plt', function_to_run='obj.fit(*args, **kwargs)', method_object='model', function_args=[eval('celsius_q'), eval('fahrenheit_a')], function_kwargs={'epochs': eval('500'), 'verbose': eval('False')}, max_wait_secs=30, custom_class=None)
