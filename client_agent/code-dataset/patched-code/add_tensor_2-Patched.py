...
c = custom_method(
tf.constant([20, 20, 30, 40]), imports='import tensorflow as tf', function_to_run='tf.constant(*args)', method_object=None, function_args=[eval('[20, 20, 30, 40]')], function_kwargs={}, max_wait_secs=0)
c = a + b
print(c)
