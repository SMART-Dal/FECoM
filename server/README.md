...
# Run  
In the activated venv run this command to start the server, perf and nvidia-smi (energy measurement tools):  
...
```  
This functionality serves debugging purposes and should not be used for energy measurement experiments since it will increase the response size drastically.  
